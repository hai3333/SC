...
%> --%>
<div class="container-fluid" style="background-color: blasck; margin-left:10%;margin-right:10%; padding-top: 0px;">
	<div class="row-fluid"  >
		<div class="span12"  >
			<!-- 顶部 -->
			<div class="page-header" style="margin-top: 0px;height: 5%;clear: all;">
				<h1 class="text-center" ><strong>作业管理系统</strong></h1>
			</div>

			<!-- 菜单栏 -->
			<nav class="navbar navbar-default" role="navigation" style="width: 16%;height: 400px;float: left" ><!-- style="background:yellow; -->
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								<span class="glyphicon glyphicon-user" style="font-size: 10px;">个人设置</span>
								<strong class="caret"></strong>
							</a>
							<ul class="dropdown-menu">
								<li><a href="#">管理员:&nbsp;${manager.m_name  } </a></li>
								<li><a href="#" class="m_personalseting">账户信息</a></li>
								<li class="divider"></li>
			...
			<hr>
			<div class="row-fluid"   style="width: 80%;height: 300px;float:left;"><!--m_teachermanage.html   -->
				<div class="span12"  >
					<div style="height: 300px;"><!-- seamless="seamless" 无边框或滚动条 -->
